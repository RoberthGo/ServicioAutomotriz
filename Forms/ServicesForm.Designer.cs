namespace ServicioAutomotriz
{
    partial class ServicesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // columns
            colID.FillWeight = 40F;            colID.HeaderText = "ID";            colID.Name = "colID";            colID.ReadOnly = true; colID.DataPropertyName = "ServiceID";
            colName.HeaderText = "Nombre";     colName.Name = "colName";           colName.ReadOnly = true;          colName.DataPropertyName = "Name";
            colDescription.HeaderText = "Descripción"; colDescription.Name = "colDescription"; colDescription.ReadOnly = true; colDescription.DataPropertyName = "Description";
            colCost.FillWeight = 70F;          colCost.HeaderText = "Costo ($)";   colCost.Name = "colCost";        colCost.ReadOnly = true; colCost.DataPropertyName = "Cost";
            colEstimatedTime.FillWeight = 70F; colEstimatedTime.HeaderText = "Tiempo (min)"; colEstimatedTime.Name = "colEstimatedTime"; colEstimatedTime.ReadOnly = true; colEstimatedTime.DataPropertyName = "EstimatedTime";
